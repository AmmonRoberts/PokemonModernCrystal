...
DEF TM01 EQU const_value
	...
	add_tm ROCK_SMASH   ; c6
	add_tm PSYCH_UP     ; c7
	add_tm HIDDEN_POWER ; c8
	add_tm SUNNY_DAY    ; c9
	add_tm SWEET_SCENT  ; ca
	add_tm SNORE        ; cb
	add_tm BLIZZARD     ; cc
	add_tm HYPER_BEAM   ; cd
	add_tm ICY_WIND     ; ce
	add_tm PROTECT      ; cf
	add_tm RAIN_DANCE   ; d0
	add_tm GIGA_DRAIN   ; d1
	add_tm ENDURE       ; d2
	add_tm FRUSTRATION  ; d3
	add_tm SOLARBEAM    ; d4
	add_tm IRON_TAIL    ; d5
	add_tm DRAGONBREATH ; d6
	add_tm THUNDER      ; d7
	add_tm EARTHQUAKE   ; d8
	add_tm RETURN       ; d9
	add_tm DIG          ; da
	add_tm PSYCHIC_M    ; db
	add_tm SHADOW_BALL  ; dc
	add_tm MUD_SLAP     ; dd
	add_tm DOUBLE_TEAM  ; de
	add_tm ICE_PUNCH    ; df
	add_tm SWAGGER      ; e0
	add_tm SLEEP_TALK   ; e1
	add_tm SLUDGE_BOMB  ; e2
	add_tm SANDSTORM    ; e3
	...
	add_tm ATTRACT      ; eb
	add_tm THIEF        ; ec
	add_tm STEEL_WING   ; ed
	add_tm FIRE_PUNCH   ; ee
	add_tm FURY_CUTTER  ; ef
	add_tm NIGHTMARE    ; f0
	add_tm THUNDER_WAVE ; new TMs
	add_tm REFLECT
	add_tm LIGHT_SCREEN
	add_tm PURSUIT
	add_tm FLAME_WHEEL
