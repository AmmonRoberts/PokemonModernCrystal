...
INCLUDE "engine/events/gift_randomizer.asm"
...
INCLUDE "engine/menus/newgame_options.asm"
INCLUDE "engine/battle/permafaint.asm"
INCLUDE "engine/battle/nuzlocke.asm"
...
INCLUDE "engine/events/eevee.asm"
INCLUDE "engine/events/tyrogue.asm"
